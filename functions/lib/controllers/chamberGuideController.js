...
const chatRequestSchema_1 = require("../schemas/chatRequestSchema");
...
function getGenAI() {
    if (!_genAI) {
        ...
        _genAI = new genai_1.GoogleGenAI({ apiKey });
    }
    return _genAI;
}
// DRIFT-1 FIX: Added region('us-west1') per project rules.
exports.chatWithGuide = functions.region('us-west1').https.onCall(async (data, context) => {
    var _a;
    try {
        ...
        const validationResult = chatRequestSchema_1.chatRequestSchema.safeParse(data);
