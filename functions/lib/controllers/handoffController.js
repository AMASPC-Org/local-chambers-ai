...
const handoffSchema_1 = require("../schemas/handoffSchema");
const handoffService = new HandoffService_1.HandoffService();
exports.generateMembershipPacket = functions.region('us-west1').https.onCall(async (data, context) => {
    // Security: Check authentication
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Authentication required.');
    }
    // Validation: Zod
    const validationResult = handoffSchema_1.handoffSchema.safeParse(data);
...
//# sourceMappingURL=handoffController.js.map